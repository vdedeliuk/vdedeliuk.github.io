export const en = {
  ...
  hero: {
    headline: "We Build Powerful Telegram Bots",
    subheadline: "Telegram Bot Development Agency",
    description:
      "From simple automation to complex payment integrations, we craft high-performance Telegram bots that drive engagement, automate workflows, and grow your business.",
    ctaText: "Start Your Bot Project",
    ctaSecondary: "View Our Bots",
  },
  nav: {
    about: "About",
    services: "Services",
  ...
  about: {
    title: "About Us",
    subtitle: "Telegram Bot Specialists",
    description:
      "We're a team of passionate developers dedicated exclusively to building exceptional Telegram bots. With years of experience and hundreds of bots deployed, we transform your ideas into powerful, scalable bot solutions that engage users and automate processes.",
    highlights: [
      {
        title: "Fast Delivery",
  ...
  contact: {
    title: "Contact",
    subtitle: "Let's Build Your Bot",
    description:
      "Ready to automate your business with a custom Telegram bot? Get in touch and let's discuss your project.",
    formFields: {
      name: "Your Name",
      email: "Your Email",
      message: "Tell us about your bot idea",
      submit: "Send Message",
    },
    sending: "Sending...",
    email: "Email",
  ...
  footer: {
    ...
    offerAgreementUrl: "https://kun.vaysed.tech/yfprnlx0.pdf",
  },
  stats: {
    botsDelivered: "Bots Delivered",
